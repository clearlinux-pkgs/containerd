...
Source0  : https://github.com/containerd/containerd/archive/v2.1.1/containerd-2.1.1.tar.gz
...
%prep
%setup -q -n containerd-2.1.1
cd %{_builddir}/containerd-2.1.1
pushd ..
cp -a containerd-2.1.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747788901
