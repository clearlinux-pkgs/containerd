...
Version  : 1.6.17
Release  : 91
URL      : https://github.com/containerd/containerd/archive/v1.6.17/containerd-1.6.17.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.6.17/containerd-1.6.17.tar.gz
...
%prep
%setup -q -n containerd-1.6.17
cd %{_builddir}/containerd-1.6.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676473598
