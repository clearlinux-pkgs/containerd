...
Version  : 1.5.13
Release  : 81
URL      : https://github.com/containerd/containerd/archive/refs/tags/v1.5.13.tar.gz
Source0  : https://github.com/containerd/containerd/archive/refs/tags/v1.5.13.tar.gz
...
%prep
%setup -q -n containerd-1.5.13
cd %{_builddir}/containerd-1.5.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659647931
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/bits-and-blooms/bitset/LICENSE %{buildroot}/usr/share/package-licenses/containerd/09a88870aebf0b3e52e5867531dcf3476ffb0b20
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/docker/spdystream/LICENSE %{buildroot}/usr/share/package-licenses/containerd/c6821d75aac4a65fae7d56a425e304beb3689c26
cp %{_builddir}/containerd-%{version}/vendor/github.com/docker/spdystream/LICENSE.docs %{buildroot}/usr/share/package-licenses/containerd/979fd7d5c67073b265d96f584aac3de1c419b8e2
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/pelletier/go-toml/LICENSE %{buildroot}/usr/share/package-licenses/containerd/cba29923f92249281f98723c1294f9b2546c50b0
...
/usr/share/package-licenses/containerd/cba29923f92249281f98723c1294f9b2546c50b0
