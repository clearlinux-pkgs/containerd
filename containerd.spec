...
Version  : 1.7.8
Release  : 108
URL      : https://github.com/containerd/containerd/archive/v1.7.8/containerd-1.7.8.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.7.8/containerd-1.7.8.tar.gz
...
%prep
%setup -q -n containerd-1.7.8
cd %{_builddir}/containerd-1.7.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698415966
