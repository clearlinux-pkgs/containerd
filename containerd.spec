...
Version  : 0.2.2
Release  : 8
URL      : https://github.com/docker/containerd/archive/v0.2.2.tar.gz
Source0  : https://github.com/docker/containerd/archive/v0.2.2.tar.gz
