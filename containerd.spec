...
Version  : 1.7.19
Release  : 117
URL      : https://github.com/containerd/containerd/archive/v1.7.19/containerd-1.7.19.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.7.19/containerd-1.7.19.tar.gz
...
%prep
%setup -q -n containerd-1.7.19
cd %{_builddir}/containerd-1.7.19
pushd ..
cp -a containerd-1.7.19 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721054893
