...
Source0  : https://github.com/containerd/containerd/archive/v1.7.0/containerd-1.7.0.tar.gz
...
%prep
%setup -q -n containerd-1.7.0
cd %{_builddir}/containerd-1.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678717200
