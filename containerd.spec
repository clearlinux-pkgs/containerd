...
Version  : 2.0.0
Release  : 122
URL      : https://github.com/containerd/containerd/archive/v2.0.0/containerd-2.0.0.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v2.0.0/containerd-2.0.0.tar.gz
...
%prep
%setup -q -n containerd-2.0.0
cd %{_builddir}/containerd-2.0.0
pushd ..
cp -a containerd-2.0.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730840165
