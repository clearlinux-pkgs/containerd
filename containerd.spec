...
Version  : 0.1.0
Release  : 2
URL      : https://github.com/docker/containerd/archive/v0.1.0.tar.gz
Source0  : https://github.com/docker/containerd/archive/v0.1.0.tar.gz
