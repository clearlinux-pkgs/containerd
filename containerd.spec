...
Version  : 2.1.0
Release  : 131
URL      : https://github.com/containerd/containerd/archive/v2.1.0/containerd-2.1.0.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v2.1.0/containerd-2.1.0.tar.gz
...
%prep
%setup -q -n containerd-2.1.0
cd %{_builddir}/containerd-2.1.0
pushd ..
cp -a containerd-2.1.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746730873
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/petermattis/goid/LICENSE %{buildroot}/usr/share/package-licenses/containerd/c700a8b9312d24bdc57570f7d6a131cf63d89016 || :
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/sasha-s/go-deadlock/LICENSE %{buildroot}/usr/share/package-licenses/containerd/92170cdc034b2ff819323ff670d3b7266c8bffcd || :
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/smallstep/pkcs7/LICENSE %{buildroot}/usr/share/package-licenses/containerd/f9bbe972432aebdebf3469c89434273ba88ec9c7 || :
...
cp %{_builddir}/containerd-%{version}/vendor/go.opentelemetry.io/auto/sdk/LICENSE %{buildroot}/usr/share/package-licenses/containerd/7df059597099bb7dcf25d2a9aedfaf4465f72d8d || :
...
cp %{_builddir}/containerd-%{version}/vendor/golang.org/x/exp/LICENSE %{buildroot}/usr/share/package-licenses/containerd/35ca00c1c9042b449d2d9b16234307841fe3a411 || :
...
cp %{_builddir}/containerd-%{version}/vendor/golang.org/x/time/LICENSE %{buildroot}/usr/share/package-licenses/containerd/35ca00c1c9042b449d2d9b16234307841fe3a411 || :
