...
Source0  : https://github.com/containerd/containerd/archive/v1.7.22/containerd-1.7.22.tar.gz
...
%prep
%setup -q -n containerd-1.7.22
cd %{_builddir}/containerd-1.7.22
pushd ..
cp -a containerd-1.7.22 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725980572
