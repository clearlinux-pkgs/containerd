...
Version  : 2.0.1
Release  : 124
URL      : https://github.com/containerd/containerd/archive/v2.0.1/containerd-2.0.1.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v2.0.1/containerd-2.0.1.tar.gz
...
%prep
%setup -q -n containerd-2.0.1
cd %{_builddir}/containerd-2.0.1
pushd ..
cp -a containerd-2.0.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735076386
