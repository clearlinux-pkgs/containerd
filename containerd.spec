...
Version  : 1.7.12
Release  : 113
URL      : https://github.com/containerd/containerd/archive/v1.7.12/containerd-1.7.12.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.7.12/containerd-1.7.12.tar.gz
...
%prep
%setup -q -n containerd-1.7.12
cd %{_builddir}/containerd-1.7.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705163704
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/container-orchestrated-devices/container-device-interface/LICENSE %{buildroot}/usr/share/package-licenses/containerd/7df059597099bb7dcf25d2a9aedfaf4465f72d8d || :
