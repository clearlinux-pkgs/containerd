...
Source0  : https://github.com/containerd/containerd/archive/v1.7.23/containerd-1.7.23.tar.gz
...
%prep
%setup -q -n containerd-1.7.23
cd %{_builddir}/containerd-1.7.23
pushd ..
cp -a containerd-1.7.23 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728948069
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/blang/semver/v4/LICENSE %{buildroot}/usr/share/package-licenses/containerd/16e22f58039363cff486afeac52bde18cd4ab5b3 || :
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/go-jose/go-jose/v3/LICENSE %{buildroot}/usr/share/package-licenses/containerd/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/containerd-%{version}/vendor/github.com/go-jose/go-jose/v3/json/LICENSE %{buildroot}/usr/share/package-licenses/containerd/7f7a12bcfc16fab2522aa1a562fd3d2aee429d3b || :
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/grpc-ecosystem/grpc-gateway/v2/LICENSE.txt %{buildroot}/usr/share/package-licenses/containerd/c2add16c875ec7abad9c453d0a0c325dc814e8f2 || :
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/klauspost/cpuid/v2/LICENSE %{buildroot}/usr/share/package-licenses/containerd/41a17a069904e6a10fa1b1bcf67c2e4d836937d1 || :
...
cp %{_builddir}/containerd-%{version}/vendor/github.com/urfave/cli/LICENSE %{buildroot}/usr/share/package-licenses/containerd/225d7794e5557038980b6f5c898175c1bac63485 || :
...
cp %{_builddir}/containerd-%{version}/vendor/golang.org/x/mod/LICENSE %{buildroot}/usr/share/package-licenses/containerd/d6a5f1ecaedd723c325a2063375b3517e808a2b5 || :
...
/VA/usr/bin/containerd-shim
/VA/usr/bin/containerd-shim-runc-v1
...
/usr/share/package-licenses/containerd/225d7794e5557038980b6f5c898175c1bac63485
...
/usr/share/package-licenses/containerd/41a17a069904e6a10fa1b1bcf67c2e4d836937d1
