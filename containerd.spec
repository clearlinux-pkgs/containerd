...
Source0  : https://github.com/containerd/containerd/archive/v1.7.20/containerd-1.7.20.tar.gz
...
%prep
%setup -q -n containerd-1.7.20
cd %{_builddir}/containerd-1.7.20
pushd ..
cp -a containerd-1.7.20 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721313325
