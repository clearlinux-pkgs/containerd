...
Source0  : https://github.com/containerd/containerd/archive/v1.6.15/containerd-1.6.15.tar.gz
...
%prep
%setup -q -n containerd-1.6.15
cd %{_builddir}/containerd-1.6.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672967000
