...
Source0  : https://github.com/containerd/containerd/archive/v2.0.5/containerd-2.0.5.tar.gz
...
%prep
%setup -q -n containerd-2.0.5
cd %{_builddir}/containerd-2.0.5
pushd ..
cp -a containerd-2.0.5 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744994957
