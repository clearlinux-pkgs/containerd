...
Version  : 1.7.21
Release  : 119
URL      : https://github.com/containerd/containerd/archive/v1.7.21/containerd-1.7.21.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.7.21/containerd-1.7.21.tar.gz
...
%prep
%setup -q -n containerd-1.7.21
cd %{_builddir}/containerd-1.7.21
pushd ..
cp -a containerd-1.7.21 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724714954
