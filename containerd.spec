...
Version  : 1.7.13
Release  : 114
URL      : https://github.com/containerd/containerd/archive/v1.7.13/containerd-1.7.13.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.7.13/containerd-1.7.13.tar.gz
...
%prep
%setup -q -n containerd-1.7.13
cd %{_builddir}/containerd-1.7.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706799061
...
cp %{_builddir}/containerd-%{version}/vendor/golang.org/x/tools/LICENSE %{buildroot}/usr/share/package-licenses/containerd/d6a5f1ecaedd723c325a2063375b3517e808a2b5 || :
