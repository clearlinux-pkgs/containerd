...
Version  : 1.7.18
Release  : 116
URL      : https://github.com/containerd/containerd/archive/v1.7.18/containerd-1.7.18.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.7.18/containerd-1.7.18.tar.gz
...
%prep
%setup -q -n containerd-1.7.18
cd %{_builddir}/containerd-1.7.18
pushd ..
cp -a containerd-1.7.18 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720034909
