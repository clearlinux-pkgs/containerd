...
Version  : 1.6.14
Release  : 87
URL      : https://github.com/containerd/containerd/archive/v1.6.14/containerd-1.6.14.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.6.14/containerd-1.6.14.tar.gz
...
%prep
%setup -q -n containerd-1.6.14
cd %{_builddir}/containerd-1.6.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672157859
