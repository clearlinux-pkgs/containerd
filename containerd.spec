...
Version  : 1.6.18
Release  : 93
URL      : https://github.com/containerd/containerd/archive/v1.6.18/containerd-1.6.18.tar.gz
Source0  : https://github.com/containerd/containerd/archive/v1.6.18/containerd-1.6.18.tar.gz
...
%prep
%setup -q -n containerd-1.6.18
cd %{_builddir}/containerd-1.6.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677253182
